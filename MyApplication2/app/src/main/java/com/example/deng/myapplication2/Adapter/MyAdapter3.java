...
public class MyAdapter3 extends Adapter<MyAdapter3.VH> {
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new VH(LayoutInflater.from(parent.getContext()).inflate(R.layout.myadapter3_layout3, parent, false));
    }
    ...
    public MyAdapter3(ArrayList<StaBean> staBeans) {
